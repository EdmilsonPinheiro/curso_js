...
document.getElementById("calcular").onclick = function(){
    ...
    if (media >= 6.5 && presenca >= 0.7){
        ...
        situacao = "Reprovado por media e presença";
    }
    else if (media < 6.5){
...
var total_vendas = 0;
document.getElementById("vendas_curso").innerHTML = "";
...
for(var b = 0; b < vendas_cursos.length; b++){
    ...
    linhaHTML = '<tr>';
    linhaHTML = '<td>' + vendas_curso[b].aluno + '</td>';
    linhaHTML = '<td>' + vendas_curso[b].data + '</td>';
    linhaHTML = '<td>' + vendas_curso[b].valor + '</td>';
    linhaHTML = '</tr>';
